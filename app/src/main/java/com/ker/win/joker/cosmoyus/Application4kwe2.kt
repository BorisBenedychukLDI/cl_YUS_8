...
import com.ker.win.joker.cosmoyus.Utils4kwe2.UtilPackage4kwe2.decodeBase64ToString
...
class Application4kwe2 : Application(){
    ...
    private fun appsFlyerSetup4kwe2 () {
        AppsFlyerLib.getInstance().run {
            ...
            init(
                BuildConfig.APPSFLYER_KEY.decodeBase64ToString(),
    ...
    private fun oneSignalSetup4kwe2 () {
        ...
        OneSignal.setAppId(BuildConfig.ONE_SIGNAL_KEY.decodeBase64ToString())
    }
    ...
    companion object {
        var key4kwe2: String? = null
        var campParam24kwe2: String? = null
        var campParam34kwe2: String? = null

        var adGroup4kwe2: String? = null
        var adSet4kwe2: String? = null
        var afChannel4kwe2: String? = null
        var mediaSource4kwe2: String? = null

        var GAID4kwe2: String? = null
        var APPSFLYER_UID_4kwe2: String? = null

        var status4kwe2:String? = null
